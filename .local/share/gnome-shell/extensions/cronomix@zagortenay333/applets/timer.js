...
const { TimePicker } = _ME.imports.utils.pickers;
...
const { show_confirm_popup, show_error_popup } = _ME.imports.utils.popup;
...
var TimerApplet = class TimerApplet extends Applet {
    time;
    state;
    preset;
    ...
    constructor(applet) {
        ...
        if (presets.length) {
            ...
            for (const [idx, preset] of presets.entries())
                scrollbox.box.add_actor(new PresetCard(applet, preset, idx).actor);
        }
