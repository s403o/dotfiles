...
const { Task } = _ME.imports.applets.todo.task;
const { LazyScrollBox } = _ME.imports.utils.scroll;
const { Markup } = _ME.imports.utils.markup.renderer;
const { Button, ButtonBox } = _ME.imports.utils.button;
const { FilePicker, Dropdown } = _ME.imports.utils.pickers;

var TrackerStats = class TrackerStats {
    today = 0;
    week = 0;
    month = 0;
    year = 0;
...
var TrackerQuery = class TrackerQuery {
    filter = '';
    since = '';
    until = '';
    sort = 'asc';
...
var TimeTracker = class TimeTracker extends PubSub {
    file = '';
    slots = Array();
    tic = 0; // 0 when paused
...
var TimeTrackerView = class TimeTrackerView {
    actor;
