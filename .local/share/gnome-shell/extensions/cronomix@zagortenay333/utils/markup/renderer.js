...
var Markup = class Markup {
    ...
    render(text, nodes) {
        ...
        for (const block of this.#ast)
            this.#content.add_actor(this.#render_block(block));
            ...
            case 'AstOrderedList':
                {
                    ...
                    for (const [idx, child] of block.children.entries()) {
                        ...
                        for (const c of child.children)
                            content.add_actor(this.#render_block(c));
                    }
                }
                break;
            ...
            case 'AstRawBlock':
                {
                    ...
                    for (const child of block.children)
                        result.add_actor(this.#render_block(child));
                    result;
                }
                break;
    ...
    #render_meta(meta) {
        ...
        for (const child of meta.children)
            body.add_actor(this.#render_block(child));
                ...
                { // Add cell widget:
                    ...
                    if (cell.children)
                        for (const child of cell.children)
                            cell_widget.add_actor(this.#render_block(child));
