...
const { Lexer } = _ME.imports.utils.markup.lexer;

var AstBase = class AstBase {
    start;
    end;
    indent;
}

var AstDummy = class AstDummy extends AstBase {
    tag = 'AstDummy';
}
var AstList = class AstList extends AstBase {
    tag = 'AstList';
    children = Array();
}
var AstListItem = class AstListItem extends AstBase {
    tag = 'AstListItem';
    children = Array();
}
var AstOrderedList = class AstOrderedList extends AstBase {
    tag = 'AstOrderedList';
    children = Array();
}
var AstSeparator = class AstSeparator extends AstBase {
    tag = 'AstSeparator';
}
var AstRawBlock = class AstRawBlock extends AstBase {
    tag = 'AstRawBlock';
    children = Array();
}
var AstHeader = class AstHeader extends AstBase {
    tag = 'AstHeader';
    child;
    size;
}
var AstParagraph = class AstParagraph extends AstBase {
    tag = 'AstParagraph';
    children = Array();
}
var AstTable = class AstTable extends AstBase {
    tag = 'AstTable';
    children = Array();
}
var AstTableRow = class AstTableRow extends AstBase {
    tag = 'AstTableRow';
    children = Array();
}
var AstTableCell = class AstTableCell extends AstBase {
    tag = 'AstTableCell';
    children = Array();
    config;
}
var AstMeta = class AstMeta extends AstBase {
    tag = 'AstMeta';
    config;
    children = Array();
}
var AstText = class AstText extends AstBase {
    tag = 'AstText';
}
var AstSub = class AstSub extends AstBase {
    tag = 'AstSub';
    children = Array();
}
var AstSup = class AstSup extends AstBase {
    tag = 'AstSup';
    children = Array();
}
var AstStrike = class AstStrike extends AstBase {
    tag = 'AstStrike';
    children = Array();
}
var AstBold = class AstBold extends AstBase {
    tag = 'AstBold';
    children = Array();
}
var AstLink = class AstLink extends AstBase {
    tag = 'AstLink';
    link;
    alias;
}
var AstItalic = class AstItalic extends AstBase {
    tag = 'AstItalic';
    children = Array();
}
var AstHighlight = class AstHighlight extends AstBase {
    tag = 'AstHighlight';
    children = Array();
}
var AstRawInline = class AstRawInline extends AstBase {
    tag = 'AstRawInline';
    children = Array();
    monospace;
}
var AstTagRef = class AstTagRef extends AstBase {
    tag = 'AstTagRef';
    child;
}
var AstFilterNot = class AstFilterNot extends AstBase {
    tag = 'AstFilterNot';
    op;
}
var AstFilterOr = class AstFilterOr extends AstBase {
    tag = 'AstFilterOr';
    op1;
    op2;
}
var AstFilterAnd = class AstFilterAnd extends AstBase {
    tag = 'AstFilterAnd';
    op1;
    op2;
}
var AstFilterAny = class AstFilterAny extends AstBase {
    tag = 'AstFilterAny';
}
var AstFilterDue = class AstFilterDue extends AstBase {
    tag = 'AstFilterDue';
}
var AstFilterDone = class AstFilterDone extends AstBase {
    tag = 'AstFilterDone';
}
var AstFilterPin = class AstFilterPin extends AstBase {
    tag = 'AstFilterPin';
}
var AstFilterHide = class AstFilterHide extends AstBase {
    tag = 'AstFilterHide';
}
var AstFilterTag = class AstFilterTag extends AstBase {
    tag = 'AstFilterTag';
    text;
}
var AstFilterTrack = class AstFilterTrack extends AstBase {
    tag = 'AstFilterTrack';
    id = -1;
}
var AstFilterFuzzy = class AstFilterFuzzy extends AstBase {
    tag = 'AstFilterFuzzy';
    needle;
}
var AstFilterString = class AstFilterString extends AstBase {
    tag = 'AstFilterString';
    needle;
}
var AstFilterPriority = class AstFilterPriority extends AstBase {
    tag = 'AstFilterPriority';
    priority = 0;
}

var AstMetaConfig = class AstMetaConfig {
    priority;
    track;
    created;
    due;
...
var AstTableCellConfig = class AstTableCellConfig {
    width = 1;
    height = 1;
    invisible = false;
}
...
function idx_to_ast_path(idx, siblings) {
    const result = Array();
