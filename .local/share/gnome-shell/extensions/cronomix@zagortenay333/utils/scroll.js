...
var ScrollBox = class ScrollBox {
    ...
    constructor(vertical = true) {
        ...
        const set_bar_opacity = (opacity) => { if (this.actor[bar])
            this.actor[bar].opacity = opacity; };
...
var LazyScrollBox = class LazyScrollBox extends ScrollBox {
    #n_children = -1;
    #fetch_size;
    #show_more_button;
    #children = null;
...
function scroll_to_widget(widget, box, scroll_to_top = false) {
    if (!widget.is_mapped())
        return;
